    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.UpdateDisplayNameSuccess ? "Your display name has been updated. It may take until your next session for changes to take effect. If old Display Name persists, try clearing your browser cache."
                : "";
